...
<div class="mx-auto text-center mb-10 lg:mb-14">
<p class="text-base text-primary-900 dark:text-primary-200 font-bold tracking-wide uppercase mb-3">Plan</p>
<h2 class="mb-4 text-4xl font-extrabold">
  Steps
</h2>
<p class="text-xl text-muted">
...
<div class="relative mt-20 w-screen max-w-[1600px] px-[30px]" style="left: calc(max(-50vw,-800px) + 50%);">
  <section>
    <div class="max-w-6xl mx-auto text-center mb-10 lg:mb-14">
      <div class="mx-auto text-center mb-10 lg:mb-14">
        <p class="text-base text-primary-900 dark:text-primary-200 font-bold tracking-wide uppercase mb-3">Recent</p>
        <h2 class="mb-4 text-4xl font-extrabold">
          Publications
        </h2>
        <p class="text-xl text-muted">
...
<section class="section-sm mt-20">
  <div class="container mx-auto">
    <div class="max-w-6xl mx-auto text-center mb-10 lg:mb-14">
      <div class="mx-auto text-center mb-10 lg:mb-14">
        <p class="text-base text-primary-900 dark:text-primary-200 font-bold tracking-wide uppercase mb-3">Contact</p>
        <h2 class="mb-4 text-4xl font-extrabold">
...
<div class="max-w-[85rem] px-4 mb-10 sm:px-6 lg:px-8 mx-auto">
  <div class="max-w-2xl lg:max-w-5xl mx-auto">
    <div class="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
      <!-- Card -->
      <div class="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8 border-neutral-200 dark:border-neutral-700 shadow-2xl">
...
<div class="rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-xl">
 ...
 <div class="mt-10 flex justify-center">
  <a href="https://card.com" title="card" class="bg-transparent hover:text-primary-900 dark:text-primary-200 prose dark:prose-invert font-semibold hover:text-white py-2 px-4 border border-primary-900 dark:border-primary-200 hover:border-transparent rounded-full">
  Card
  </a>
</div>
</div>
...
<div class="block max-w-2xl mt-20 mx-auto">
   <section class="mx-auto">
<div class="mx-auto text-center mb-10 lg:mb-14">
<p class="text-base text-primary-900 dark:text-primary-200 font-bold tracking-wide uppercase mb-3">Books</p>
<h2 class="mb-4 text-4xl font-extrabold">
...
<p class="text-xl text-muted">
 ...
 <div class="flex justify-center">
    <a href="https://books.com" title="books" class="bg-transparent hover:text-primary-900 dark:text-primary-200 prose dark:prose-invert font-semibold hover:text-white py-2 px-4 border border-primary-900 dark:border-primary-200 hover:border-transparent rounded-full">
  Read books
  </a>
</div>
</div>
...
<div class="mx-auto text-center mb-10 lg:mb-14">
<p class="text-base text-primary-900 dark:text-primary-200 font-bold tracking-wide uppercase mb-3">Pricing</p>
<h2 class="mb-4 text-4xl font-extrabold">
...
<p class="text-xl text-muted">
  ...
  <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
    ...
    <a href="https://free.com" title="free" class="mt-6 bg-transparent hover:text-primary-900 dark:text-primary-200 prose dark:prose-invert font-semibold hover:text-white py-2 px-4 border border-primary-900 dark:border-primary-200 hover:border-transparent rounded-full">
  Get it free
  </a>
    </div>
    <!-- End Card -->
    ...
    <div class="flex flex-col border-2 border-primary-900 dark:border-primary-200 text-center rounded-xl py-8 px-8 shadow-2xl">
      ...
      <a href="https://product.com" title="product" class="mt-6 bg-transparent hover:text-primary-900 dark:text-primary-200 prose dark:prose-invert font-semibold hover:text-white py-2 px-4 border border-primary-900 dark:border-primary-200 hover:border-transparent rounded-full">
     Product
     </a>
    </div>
    <!-- End Card -->
    ...
    <div class="flex flex-col border border-neutral-200 text-center rounded-xl py-8 px-8 dark:border-neutral-700 shadow-2xl">
      ...
      <a href="https://support.com" title="support" class="mt-6 bg-transparent hover:text-primary-900 dark:text-primary-200 prose dark:prose-invert font-semibold hover:text-white py-2 px-4 border border-primary-900 dark:border-primary-200 hover:border-transparent rounded-full">
     Support
    </a>
    </div>
    <!-- End Card -->
    ...
    <div class="flex flex-col border border-neutral-200 text-center rounded-xl py-8 px-8 dark:border-neutral-700 shadow-2xl">
      ...
      <a href="https://all.com" title="all" class="mt-6 bg-transparent hover:text-primary-900 dark:text-primary-200 prose dark:prose-invert font-semibold hover:text-white py-2 px-4 border border-primary-900 dark:border-primary-200 hover:border-transparent rounded-full">
      all 
      </a>
    </div>
  </div>
  <div class="mt-10 flex justify-center">
  <a href="https://compare.com" title="compare" class="bg-transparent hover:text-primary-900 dark:text-primary-200 prose dark:prose-invert font-semibold hover:text-white py-2 px-4 border border-primary-900 dark:border-primary-200 hover:border-transparent rounded-full">
  Compare
  </a>
</div>
</div>
...
<div class="mx-auto text-center mb-10 lg:mb-14">
<p class="text-base text-primary-900 dark:text-primary-200 font-bold tracking-wide uppercase mb-3">Testimonials</p>
<h2 class="mb-4 text-4xl font-extrabold">
