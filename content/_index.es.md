...
<section class="cointainer">
  <!-- Jumbotron -->
  <div class="px-6 py-6 text-center md:px-12">
    <div class="w-100 mx-auto sm:max-w-2xl">
      <div class="grid items-center gap-12 lg:grid-cols-2 mb-20">
        <div class="lg:mt-0">
          ...
          <h2 class="mb-8 text-4xl font-extrabold text-primary-600 dark:text-primary-400">template for Astro 4.0 + Tailwind CSS
          </h2>
          ...
          <a href="#" class="inline-flex justify-center items-center mt-4 py-3 px-5 sm:ms-4 text-center rounded-full text-neutral-50 bg-primary-600 dark:bg-primary-900">
           Read more
        </a>
        <span class="mr-2"></span>
          <a href="#" class="inline-flex justify-center items-center mt-6 py-3 px-5 text-center bg-transparent hover:text-primary-600 prose dark:prose-invert font-semibold border border-primary-500 hover:border-transparent rounded-full">
            Ask a Question
  ...
  <!-- Quote -->
  <section>
<div class="px-6 py-6 mb-20 rounded-xl text-neutral-50" style="background-color:#1b3c89">
...
<p class="text-xl">
  ...
  <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
    ...
    <div class="flex flex-col border border-neutral-200 text-center rounded-xl py-8 px-8 dark:border-neutral-700">
      <h4 class="font-medium text-lg text-neutral-800 dark:text-neutral-200">Free</h4>
    ...
    <div class="flex flex-col border-2 border-primary-500 text-center shadow-xl rounded-xl py-8 px-8 dark:border-primary-700">
      ...
      <h4 class="font-medium text-lg text-neutral-800 dark:text-neutral-200">Startup</h4>
    ...
    <!-- Card -->
    <div class="flex flex-col border border-neutral-200 text-center rounded-xl py-8 px-8 dark:border-neutral-700">
      <h4 class="font-medium text-lg text-neutral-800 dark:text-neutral-200">Team</h4>
      <span class="mt-5 font-bold text-5xl text-neutral-800 dark:text-neutral-200">
        <span class="font-bold text-2xl -me-2">$</span>
        89
      </span>
    ...
    <!-- Card -->
    <div class="flex flex-col border border-neutral-200 text-center rounded-xl py-8 px-8 dark:border-neutral-700">
      <h4 class="font-medium text-lg text-neutral-800 dark:text-neutral-200">Enterprise</h4>
      <span class="mt-5 font-bold text-5xl text-neutral-800 dark:text-neutral-200">
        <span class="font-bold text-2xl -me-2">$</span>
        149
      </span>
